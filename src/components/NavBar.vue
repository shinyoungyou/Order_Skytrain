  ...
  <nav v-show="logFlag && loginFlag" class="navbar navbar-expand-sm navbar-light" style="background-color: #fff; border-bottom: 1px solid #ececec">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavId">
      <ul class="navbar-nav me-auto mt-2 mt-lg-0">
        <li class="nav-item">
          <router-link active-class="active" class="nav-link" to="/menu" aria-current="page">Menu<span class="visually-hidden">(current)</span></router-link>
        </li>
        <li class="nav-item">
          <router-link active-class="active" class="nav-link" to="/sandwiches">Sandwiches</router-link>
        </li>
        <li class="nav-item">
          <router-link active-class="active" class="nav-link" to="/salads">Salads</router-link>
        </li>
        <li class="nav-item">
          <router-link active-class="active" class="nav-link" to="/breakfast">Breakfast</router-link>
        </li>
